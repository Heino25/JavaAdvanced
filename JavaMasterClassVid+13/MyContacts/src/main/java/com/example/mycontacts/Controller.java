...
public class Controller {
    ...
    public void showAddContactDialog() {
        ...
        dialog.setTitle("Add New com.example.mycontacts.Contact");
    ...
    public void showEditContactDialog() {
        ...
        if (selectedContact == null) {
            ...
            alert.setTitle("No com.example.mycontacts.Contact Selected");
        ...
        dialog.initOwner(mainPanel.getScene().getWindow());
        dialog.setTitle("Edit com.example.mycontacts.Contact");
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("contactdialog.fxml"));
        try {
            dialog.getDialogPane().setContent(fxmlLoader.load());
    ...
    public void deleteContact() {
        ...
        alert.setTitle("Delete com.example.mycontacts.Contact");
        alert.setHeaderText(null);
